        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('admin.proveedores.index') }}">Productos</a></li>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nombre_contacto" name="nombre_contacto"
                                        value="{{ $proveedor->nombre_contacto }}" class="form-control">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="empresa" name="empresa" value="{{ $proveedor->empresa }}"
                                        class="form-control">
                                    @error('empresa')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="nit" name="nit" value="{{ $proveedor->nit }}"
                                        class="form-control">
                                    @error('nit')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="direccion" name="direccion"
                                        value="{{ $proveedor->direccion }}" class="form-control">
                                    @error('direccion')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="telefono" name="telefono" value="{{ $proveedor->telefono }}"
                                        class="form-control">
                                    @error('telefono')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
