            ...
            <form method="POST" action="{{ route('admin.productos.update', $producto->id) }}"
                ...
                <div class="row">
                    <div class="col-md-3">
                        ...
                        <br>
                        <output id="list"
                            style="display: flex; flex-wrap: nowrap; align-content: center; justify-content: center; align-items: center; flex-direction: row;">
                            <img src="{{ asset('storage/' . $producto->imagen) }}" class="thumb thumbail" width="50%"
                                alt="Producto" />
                        </output>
                        <script>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stock_minimo" name="stock_minimo"
                                        value="{{ $producto->stock_minimo }}" class="form-control">
                                    @error('stock_minimo')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="number" id="stock_maximo" name="stock_maximo"
                                        value="{{ $producto->stock_maximo }}" class="form-control">
                                    @error('stock_maximo')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </div>
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <input type="date" id="fecha_ingreso" name="fecha_ingreso"
                                        value="{{ $producto->fecha_ingreso }}" class="form-control">
                                    @error('fecha_ingreso')
                                        <small style="color: red">{{ $message }}</small>
                                    @enderror
                                </div>
